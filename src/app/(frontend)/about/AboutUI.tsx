...
// import { CheckCircle2, BookOpen, ShieldCheck, Home } from 'lucide-react'
...
//           <motion.h1 {...fadeUp} className="text-5xl md:text-7xl font-extrabold mb-6 tracking-tight text-slate-900">
//             {hero.title}
//           </motion.h1>
...
//               <span className="font-medium">ESTD {establishedYear}</span>
//               <div className="h-px w-12 bg-slate-200" />
//             </div>
//           )}
//         </div>
...
//           <h2 className="text-center text-4xl font-bold">School Leadership</h2>

//           {leadership.map((leader: any, i: number) => {
//             const image =
//               leader.image && typeof leader.image === 'object'
//                 ? (leader.image as Media)
//                 : null

//             return (
//               <motion.div key={i} {...fadeUp} className="bg-white p-10 rounded-[3rem] border flex flex-col md:flex-row gap-8">
//                 <div className={`relative w-48 h-48 rounded-3xl overflow-hidden ${leader.gradient}`}>
//                   {image?.url && (
...
//                   <p className="text-amber-700 uppercase text-sm tracking-widest">{leader.role}</p>
//                   <p className="italic text-slate-600 mt-4">{leader.message}</p>
//                   <p className="text-slate-500 mt-2"> <span className='text-amber-500' >Message from : </span> {leader.introduction}</p>
//                 </div>
//               </motion.div>
//             )
//           })}
...
//                   key={i}
//                   whileHover={{ y: -5 }}
//                   className="p-6 rounded-3xl bg-slate-50 border text-center hover:bg-primary hover:text-white transition"
//                 >
//                   <span className="text-4xl text-blue-800 block font-bold mb-2 group-hover:opacity-100">
//                     {item.letter}
//                   </span>
//                   <span className="font-bold block text-red-500 hover:text-white ">{item.word}</span>
//                   <span className="text-xs block text-blue-950">{item.description}</span>
//                 </motion.div>
//               ))}
//             </div>
//           </div>
...
//         <section className="py-20 container mx-auto px-4">
//           <div className="bg-white rounded-[3rem] p-10 border">
//             <div className="grid md:grid-cols-3 gap-10">
//               <div>
//                 <Home className="text-secondary mb-4" />
//                 <h2 className="text-4xl font-bold mb-4">House System for Education beyond classrooms </h2>
//                 <p className="text-slate-600">{houseSystem.description}</p>
//               </div>

//               <div className="md:col-span-2 grid sm:grid-cols-2 gap-6">
//                 {houseSystem.houses?.map((house: any, i: number) => (
//                   <div key={i} className="p-6 rounded-2xl bg-slate-50 border flex gap-4">
//                     <div className="w-4 h-12 rounded-full" style={{ backgroundColor: house.hexColor || '#ccc' }} />
//                     <div>
//                       <h4 className="font-bold">{house.name}</h4>
//                       <span className="text-xs uppercase text-slate-400">{house.colorName}</span>
//                       <p className="text-sm text-slate-500 mt-1">{house.motto}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//             <h2 className="text-3xl font-bold mb-6">School Norms</h2>
//             <ul className="space-y-4">
//               {regulations.norms?.map((n: any, i: number) => (
//                 <li key={i} className="bg-white/5 p-4 rounded-xl text-sm">
//                   {n.item}
//                 </li>
//               ))}
//             </ul>
...
//           <div>
//             <BookOpen className="text-secondary mb-4" />
//             <h2 className="text-3xl font-bold mb-6">School Rules</h2>
