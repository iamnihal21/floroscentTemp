...
export default function ContactPage() {
  ...
  useEffect(() => {
    const fetchContactData = async () => {
      try {
        const data = await payload.getContactPage()
        if (data) {
          setContactData(data)
        } else {
          ...
          setContactData({
            heroSection: {
              ...
              title: 'Contact Us',
              highlightedWord: 'Us',
              description: "We're here to help! Reach out to us for any queries, concerns, or support you may need.",
            },
            contactInfo: {
              primaryEmail: 'info@florescent.edu.in',
              secondaryEmail: 'admissions@florescent.edu.in',
              address: 'Florescent Public School\nSector 15, Vasant Kunj\nNew Delhi - 110070\nIndia',
            },
            supportHours: [
              { day: 'Weekdays', hours: '8:00 AM - 5:00 PM' },
              { day: 'Saturday', hours: '9:00 AM - 1:00 PM' },
            ...
            responseTime: {
              ...
              admissionResponse: '48 hours',
            },
            locationInfo: {
              mapEmbedUrl: 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.0244310670387!2d72.5199150753149!3d23.059565879147904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e835519d27f37%3A0xa903dd3f424f9a0f!2sFlorescent%20school!5e0!3m2!1sen!2sin!4v1763745880149!5m2!1sen!2sin',
              metroInfo: 'Nearest station: Vasant Kunj Metro Station (5 minutes walk)',
              busInfo: 'Bus routes: 543, 621, 715 (Stop: Florescent Public School)',
              carInfo: 'Ample parking available in the school premises',
            },
            visitingHours: [
            ...
            additionalContacts: {
              hrEmail: 'hr@florescent.edu.in',
              hrOfficeHours: 'Mon-Fri, 9:00 AM - 5:00 PM',
              hrResponseTime: '3-5 business days',
            },
            formSubjects: [
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await payload.submitContactForm(formData)
      setSubmitSuccess(true)
      setFormData({
        name: "",
        email: "",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-16 md:py-24 lg:py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <span className="inline-block px-4 py-2 bg-secondary/10 text-chart-1 rounded-full text-sm font-semibold mb-6">
              {contactData.heroSection.badgeText}
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-6">
              {contactData.heroSection.title.split(' ')[0]} <span className="text-chart-1">{contactData.heroSection.highlightedWord}</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              ...
              <div className="lg:col-span-1 space-y-8">
                ...
                >
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-foreground mb-1">Email Address</h3>
                        <p className="text-muted-foreground">{contactData.contactInfo.primaryEmail}</p>
                        <p className="text-sm text-muted-foreground">{contactData.contactInfo.secondaryEmail}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="font-semibold text-foreground mb-1">Office Hours</h3>
                        <div className="space-y-2">
                          {contactData.supportHours.map((item: any, idx: number) => (
                            <div key={idx} className="flex justify-between">
                              <span className="text-muted-foreground mx-3">{item.day}</span>
                              <span className="font-medium text-foreground">{item.hours}</span>
                            </div>
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Email Response</span>
                      <span className="font-bold text-chart-1">{contactData.responseTime.emailResponse}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Phone Response</span>
                      <span className="font-bold text-chart-1">{contactData.responseTime.phoneResponse}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Admission Queries</span>
                      <span className="font-bold text-chart-1">{contactData.responseTime.admissionResponse}</span>
                    </div>
                  </div>
                </motion.div>
              </div>
                ...
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-background border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-chart-1"
                        >
                          {contactData.studentGrades.map((grade: any, index: number) => (
                    ...
                    <div>
                      ...
                      >
                        <option value="">Select a subject</option>
                        {contactData.formSubjects.map((subject: any, index: number) => (
      ...
      <section className="py-16 md:py-24 bg-card/30">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {contactData.departmentContacts.map((contact: any, index: number) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        ...
                        {contact.extension && (
                          <div className="text-sm text-muted-foreground">
                            Extension: <span className="font-medium">{contact.extension}</span>
                          </div>
                        )}
                      </div>
                    </div>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-red-500/5 to-orange-500/5 rounded-2xl p-6 md:p-8 border border-red-500/20">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {contactData.emergencyContacts.map((contact: any, index: number) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-gradient-to-br from-secondary/20 to-accent/20 rounded-2xl overflow-hidden h-[400px] relative">
                  <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center">
                    <iframe
                      src={contactData.locationInfo.mapEmbedUrl}
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
              ...
              <div className="space-y-6">
                <div className="bg-background rounded-2xl p-6 border border-border">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">By Metro</h4>
                      <p className="text-sm text-muted-foreground">
                        {contactData.locationInfo.metroInfo}
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">By Bus</h4>
                      <p className="text-sm text-muted-foreground">
                        {contactData.locationInfo.busInfo}
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-foreground mb-2">By Car</h4>
                      <p className="text-sm text-muted-foreground">
                        {contactData.locationInfo.carInfo}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-br from-chart-1/5 to-chart-2/5 rounded-2xl p-6 border border-border">
                  ...
                  <div className="space-y-3">
                    {contactData.visitingHours.map((visit: any, index: number) => (
                      <div key={index} className="flex justify-between">
                        <span className="text-muted-foreground">{visit.category}</span>
                        <span className="font-medium text-foreground">{visit.hours}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="bg-background rounded-2xl p-8 md:p-12 border border-border shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div className="text-center">
                  ...
                  <h4 className="font-bold text-foreground mb-2">Email</h4>
                  <p className="text-muted-foreground">{contactData.additionalContacts.hrEmail}</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="font-bold text-foreground mb-2">Office Hours</h4>
                  <p className="text-muted-foreground">{contactData.additionalContacts.hrOfficeHours}</p>
                </div>
              </div>
              ...
              <div className="bg-card rounded-xl p-6">
                <h4 className="font-bold text-foreground mb-4">Response Time</h4>
                <p className="text-muted-foreground text-sm">
                  Applications are reviewed within <span className="text-accent font-medium">{contactData.additionalContacts.hrResponseTime}</span>. 
                  Shortlisted candidates will be contacted for the next steps.
                </p>
              </div>
            </div>
