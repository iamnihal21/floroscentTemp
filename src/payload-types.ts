...
export interface Schedule {
  id: number;
  title: string;
  type: 'exam' | 'ptm' | 'calendar';
  date?: string | null;
  pdfAttachment?: (number | null) | Media;
  updatedAt: string;
  createdAt: string;
}
/**
...
export interface Achievement {
  id: number;
  title: string;
  type?: ('Board Result' | 'Co-curricular' | 'Student Achievement' | 'School Achievement') | null;
  year?: number | null;
  description?: {
    root: {
      type: string;
